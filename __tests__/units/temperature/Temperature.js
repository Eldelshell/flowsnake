...
const tests = [{
    ...
    from: '°F',
    to: '°C',
    values: [{ a: 410, b: 210 }, { a: 32, b: 0 }, { a: -148, b: -100 }]
},{
    from: '°F',
    to: 'K',
    values: [{ a: 410, b: 483.15 },{ a: -100, b: 199.82 }]
},{
    from: '°F',
    to: '°R',
    ...
    from: '°R',
    to: '°C',
    values: [{ a: 100, b: -217.59 },{ a: 0, b: -273.15 },{ a: -100, b: -328.71 }]
},{
    from: '°R',
    to: '°F',
    ...
    from: '°R',
    to: 'K',
    values: [{ a: 100, b: 55.56 },{ a: 0, b: 0 },{ a: -100, b: -55.56 }]
}];
