...
import Conductance from './units/electricity/Conductance';
import Inductance from './units/electricity/Inductance';
import Potential from './units/electricity/Potential';
import Resistance from './units/electricity/Resistance';
import Capacitance from './units/electricity/Capacitance';
...
import PixelDensity from './units/PixelDensity';
...
import Density from './units/density/Density';
import AngularVelocity from './units/velocity/angular/AngularVelocity';
...
Units.prototype.as = function(u) {
    ...
    const unit = descriptor.getUnit(u);
