const Prefix = {
    ...
    CUBIC: [
        // Macro
        {id: 'da', name: 'Deca', converter: 1*(10**3)},
        {id: 'h', name: 'Hecto', converter: 1*(10**6)},
        {id: 'k', name: 'Kilo', converter: 1*(10**9)},
        {id: 'M', name: 'Mega', converter: 1*(10**18)},
        {id: 'G', name: 'Giga', converter: 1*(10**27)},
        {id: 'T', name: 'Tera', converter: 1*(10**36)},
        {id: 'P', name: 'Peta', converter: 1*(10**45)},
        {id: 'E', name: 'Exa', converter: 1*(10**54)},
        {id: 'Z', name: 'Zetta', converter: 1*(10**63)},
        {id: 'Y', name: 'Yotta', converter: 1*(10**72)},
        // Micro
        {id: 'd', name: 'Deci', converter: 1/(10**3)},
        {id: 'c', name: 'Centi', converter: 1/(10**6)},
        {id: 'm', name: 'Milli', converter: 1/(10**9)},
        {id: 'u', name: 'Micro', converter: 1/(10**18)},
        {id: 'µ', name: 'MicroSI', converter: 1/(10**18)},
        {id: 'n', name: 'Nano', converter: 1/(10**27)},
        {id: 'p', name: 'Pico', converter: 1/(10**36)},
        {id: 'f', name: 'Femto', converter: 1/(10**45)},
        {id: 'a', name: 'Atto', converter: 1/(10**54)},
        {id: 'z', name: 'Zepto', converter: 1/(10**63)},
        {id: 'y', name: 'Yocto', converter: 1/(10**72)}
    ],
