...
/**
 * A Triangle object
 * Each side has an id either a, b or d.
 ...
 * @property {BigDecimal} perimiter - the perimeter of the triangle.
...
export default class Triangle extends Polygon {
     ...
     * @param {Object<Number>} sides - the sides.
     * @param {Object<Number>} angles - the angles.
     * @constructor
     */
    ...
    solveAAS() {
        ...
        if(!this.sides.a){
            ...
            this.sides.b = this.sideOf(this.angles.b, this.sides.b, this.angles.c);
            return this.solveAAS();
        }else if(!this.sides.c && this.sides.a){
            this.sides.b = this.sideOf(this.angles.a, this.sides.a, this.angles.c);
            return this.solveAAS();
        }
     ...
     */
    numberOfEqualAngles() {
        if(!(this.angles.a && this.angles.b && this.angles.c)){
            return 0;
        }

        let eq = 1;
        this.getAngles().reduce((c, p) => {
            if(p.eq(c)){
                eq++;
            }
            return c;
    ...
    solve() {
        ...
        if(this.isAAA()){
            this.getType();
            // Since we cannot know anything else of this triangles, we return there.
        ...
        this.heights.a = this.heightOf('a');
        this.heights.b = this.heightOf('b');
        this.heights.c = this.heightOf('c');
